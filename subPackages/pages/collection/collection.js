...
Page({
  ...
  data: {
    ...
    actList: [
      {
        title: '标题1', classify: '分类1', date: '时间1',
        img: '/assets/activity/swiper1.jpg',
        dateShow: ''
      },
      {
        title: '标题2', classify: '分类2', date: '时间2', img: '/assets/activity/swiper2.jpg',
        dateShow: ''
      },
      {
        title: '标题3', classify: '分类3', date: '时间2', img: '/assets/activity/swiper3.jpg',
        dateShow: ''
      },
      {
        title: '标题4', classify: '分类4', date: '时间3', img: '/assets/activity/swiper4.jpg',
        dateShow: ''
      },
    ],
  ...
  onReady() {
    ...
    for (var i = 1; i < actList.length; i++) {
      if (actList[i].date == actList[i - 1].date)
        actList[i].dateShow = 'hidden';
      else actList[i].dateShow = 'show';
    }
